...
let fromVertices
    (givenVertices: Point2D<'Units, 'Coordinates> * Point2D<'Units, 'Coordinates> * Point2D<'Units, 'Coordinates>)
    : Triangle2D<'Units, 'Coordinates> =
...
let vertices
    ...
    : Point2D<'Units, 'Coordinates> * Point2D<'Units, 'Coordinates> * Point2D<'Units, 'Coordinates> =
...
let edges
    (triangle: Triangle2D<'Units, 'Coordinates>)
    : LineSegment2D<'Units, 'Coordinates> * LineSegment2D<'Units, 'Coordinates> * LineSegment2D<'Units, 'Coordinates> =
...
let centroid (triangle: Triangle2D<'Units, 'Coordinates>) : Point2D<'Units, 'Coordinates> =
...
/// `None`.
let circumcircle (triangle: Triangle2D<'Units, 'Coordinates>): Circle2D<'Units, 'Coordinates> option=
...
let scaleAbout (point: Point2D<'Units, 'Coordinates>) (scale: float) (triangle: Triangle2D<'Units, 'Coordinates>): Triangle2D<'Units, 'Coordinates> =
    mapVertices (Point2D.scaleAbout point scale) triangle


/// Rotate a triangle around a given point by a given angle.
let rotateAround (centerPoint: Point2D<'Units, 'Coordinates>) (angle: Angle) (triangle: Triangle2D<'Units, 'Coordinates>): Triangle2D<'Units, 'Coordinates> =
    mapVertices (Point2D.rotateAround centerPoint angle) triangle

/// Translate a triangle by a given displacement.
let translateBy (vector: Vector2D<'Units, 'Coordinates>)  (triangle: Triangle2D<'Units, 'Coordinates>): Triangle2D<'Units, 'Coordinates> =
...
let mirrorAcross (axis: Axis2D<'Units, 'Coordinates>) (triangle: Triangle2D<'Units, 'Coordinates>): Triangle2D<'Units, 'Coordinates> =
...
let relativeTo (frame: Frame2D<'Units, 'Coordinates, 'Defines>) (triangle: Triangle2D<'Units, 'Coordinates>): Triangle2D<'Units, 'Coordinates> =
...
let placeIn (frame: Frame2D<'Units, 'Coordinates, 'Defines>) (triangle: Triangle2D<'Units, 'Coordinates>) : Triangle2D<'Units, 'Coordinates> =
...
let contains (point: Point2D<'Units, 'Coordinates>) (triangle: Triangle2D<'Units, 'Coordinates>) : bool =
...
/// otherwise.
let counterclockwiseArea (triangle: Triangle2D<'Units, 'Coordinates>) : Quantity<'Units Squared> =
...
let clockwiseArea (triangle: Triangle2D<'Units, 'Coordinates>) : Quantity<'Units Squared> = -(counterclockwiseArea triangle)

/// Get the area of a triangle. The result will always be positive regardless of
/// whether the triangle's vertices are in clockwise or counterclockwise order.
let area (triangle: Triangle2D<'Units, 'Coordinates>) : Quantity<'Units Squared> =
